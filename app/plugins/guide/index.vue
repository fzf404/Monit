...
<template>
  ...
  <section class="flex-col-center gap-y-3 p-4 pt-9">
    ...
    <i18n-t keypath="tray" tag="p" class="flex-row-center text-sm text-gray-300">
      <img class="inline-block h-5 px-1" :src="MonitSVG" />
    </i18n-t>
    <p class="text-sm text-gray-400">
      {{ t('button') }}
    </p>
    <button class="bg-purple rounded p-1 opacity-80 hover:opacity-100 dark:bg-purple-600">
